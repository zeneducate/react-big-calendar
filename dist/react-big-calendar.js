  ...
  */
  ...
  function sortEvents$1(eventA, eventB, accessors, localizer) {
    var evtA = {
      ...
      sortOrder: accessors.sortOrder(eventA),
    }
    var evtB = {
      start: accessors.start(eventB),
      end: accessors.end(eventB),
      allDay: accessors.allDay(eventB),
      sortOrder: accessors.sortOrder(eventB),
    }
  ...
  var Calendar = /*#__PURE__*/ (function(_React$Component) {
    ...
    _proto.getContext = function getContext(_ref2) {
      var startAccessor = _ref2.startAccessor,
        ...
        sortOrderAccessor = _ref2.sortOrderAccessor,
